...
describe('Proper Messages according to Certain inputs on Validation Promo Code C1W1', function()  {

      this.retries(4);

    it('should display message Please select your Resort when apply code without selecting resort/dates C1W1', ()=> {

    console.log('TEST STARTING: Display message Please select your Resort when apply code without selecting resort/dates C1W1');
    ...
    it('should display message Please select a valid Check-in-date C1W1', ()=> {

    console.log('TEST STARTING: Display message Please select a valid Check-in-date C1W1');
...
it('should display message Please enter a Promotional Code C1W1', ()=> {

    console.log('TEST STARTING: Display message Please enter a Promotional Code C1W1');
...
it('should display message Sorry. The promo code you entered is invalid C1W1', ()=> {

    console.log('TEST STARTING: Display message Sorry. The promo code you entered is invalid C1W1');
...
it('should display message The group code provided could not be matched with any existing group C1W1.', ()=> {

  console.log('TEST STARTING: Display message The group code provided could not be matched with any existing group C1W1.');
