...
describe('Remanining Balance Date C1W4', function()  {

     this.retries(4);
    
    it('should test Remaining Balance Date less than 15 days C1W4', ()=> {

            console.log('TEST STARTING: Remaining Balance Date less than 15 days C1W4');
    ...
    it('should test Remaining Balance Date 15-30 days C1W4', ()=> {

            console.log('TEST STARTING: Remaining Balance Date 15-30 days C1W4');
    ...
    it('should test Remaining Balance Date 30-45 days C1W4', ()=> {

            console.log('TEST STARTING: Remaining Balance Date 30-45 days C1W4');
       ...
       expect(date2Days).to.equal(dateBalanceDue);
        ...
        it('should test Remaining Balance Date 45-50 days C1W4', ()=> {

            console.log('TEST STARTING: Remaining Balance Date 45-50 days C1W4');
            ObePage.open('IP OF APPLICATION');
       ...
       expect(date7Days).to.equal(dateBalanceDue);
        ...
        it('should test Remaining Balance Date 50 days C1W4', ()=> {

            console.log('TEST STARTING: Remaining Balance Date 50 days C1W4');
