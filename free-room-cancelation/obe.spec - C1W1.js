...
describe('Free Room Cancelation C1W1', function()  {

      this.retries(4);
   
    
    it('should test Free Room Cancellation Date less than 45 days C1W1', ()=> {

            console.log('TEST STARTING: Free Room Cancellation Date less than 45 days C1W1');
    ...
    it('should test Free Room Cancellation Date more than 45 days C1W1', ()=> {


        console.log('TEST STARTING: Free Room Cancellation Date more than 45 days C1W1');
