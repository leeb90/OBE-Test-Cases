...
describe('Insurance Amount Sandals C1W2', function()  {

      this.retries(4);
    
    it('should test insurance amount on Sandals resorts for USA for arrivals between 12-21 and 1-2 C1W2', ()=> {

            console.log('TEST STARTING: Insurance amount on Sandals resorts for USA for arrivals between 12-21 and 1-2 C1W2');
     ...
     it('should test insurance amount on Sandals resorts for Canada for arrivals between 12-21 and 1-2 C1W2', ()=> {

            console.log('TEST STARTING: Insurance amount on Sandals resorts for Canada for arrivals between 12-21 and 1-2 C1W2');
