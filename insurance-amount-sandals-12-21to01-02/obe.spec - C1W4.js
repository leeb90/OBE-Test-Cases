...
describe('Insurance Amount Sandals C1W4', function()  {

     this.retries(4);
    
    it('should test insurance amount on Sandals resorts for USA for arrivals between 12-21 and 1-2 C1W4', ()=> {

            console.log('TEST STARTING: Insurance amount on Sandals resorts for USA for arrivals between 12-21 and 1-2 C1W4');
     ...
     it('should test insurance amount on Sandals resorts for Canada for arrivals between 12-21 and 1-2 C1W4', ()=> {

            console.log('TEST STARTING: Insurance amount on Sandals resorts for Canada for arrivals between 12-21 and 1-2 C1W4');

            ObePage.open('https://172.16.208.53/index.cfm?');
            Resort= resortArray[Math.floor(Math.random() * resortArray.length)];
