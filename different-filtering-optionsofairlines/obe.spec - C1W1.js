...
describe('Diferent Filtering Options of Airlines C1W1', function()  {

     this.retries(4);
  
    
    it('should test Different Search Departure Airports are present C1W1', ()=> {

      console.log('TEST STARTING: Different Search Departure Airports are present C1W1');
    ...
    it('should test Verify Search By Fare and Search by First Class Business options are available on first page of the application C1W1', ()=> {

      console.log('TEST STARTING: Verify Search By Fare and Search by First Class Business options are available on first page of the application C1W1');
     ...
     it('should test Verify Search By Fare and Search by First Class Business options are available on requote section C1W1', ()=> {

      console.log('TEST STARTING: Verify Search By Fare and Search by First Class Business options are available on requote section C1W1');
