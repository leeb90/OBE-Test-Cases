...
describe('Proper Messages according to Certain inputs C1W3', function()  {

    this.retries(4);
    
    it('should display message Please select your travel dates without inputs C1W3', ()=> {

      console.log('TEST STARTING: Display message Please select your travel dates without inputs C1W3');
    ...
    it('should display message Please select your travel dates when input is only Resort C1W3', ()=> {

      console.log('TEST STARTING: Display message Please select your travel dates when input is only Resort C1W3');
    ...
    it('should display message Please select a date in the future when select past date C1W3', ()=> {

      console.log('TEST STARTING: Display message Please select a date in the future when select past date C1W3');
    ...
    it('should display message Please select a resort first to quote C1W3', ()=> {


      console.log('TEST STARTING: Display message Please select a resort first to quote C1W3');
    ...
    it('should display message Sorry Last Minute Reservation C1W3', ()=> {

     console.log('TEST STARTING: Display message Sorry Last Minute Reservation C1W3');
    ...
    it('should display message Sorry Last Minute Reservation on step2 Requote C1W3', ()=> {

    console.log('TEST STARTING: Display message Sorry Last Minute Reservation on step 2 Requote C1W3');
    ...
    console.log("LA FECHA ES " + AddDays);
    month= AddDays.slice(4,7);
    date= AddDays.slice(8,10);
    year=AddDays.slice(11,15);
    ...
    it('should display message Air cannot be selected for dates more than 330 C1W3', ()=> {

    console.log('TEST STARTING: Display message Air cannotbe selected for dates more than 330 C1W3');
    ...
    it('should display message Air cannot be selected for dates more than 330 Requote C1W3', ()=> {

    console.log('TEST STARTING: Display message Air cannot be selectedfor dates more than 330 Requote C1W3');
