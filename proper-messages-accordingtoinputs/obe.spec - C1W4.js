...
describe('Proper Messages according to Certain inputs C1W4', function()  {

      this.retries(4);

    
    it('should display message Please select your travel dates without inputs C1W4', ()=> {

      console.log('TEST STARTING: Display message Please select your travel dates without inputs C1W4');
    ...
    it('should display message Please select your travel dates when input is only Resort C1W4', ()=> {

      console.log('TEST STARTING: Display message Please select your travel dates when input is only Resort C1W4');
    ...
    it('should display message Please select a date in the future when select past date C1W4', ()=> {

      console.log('TEST STARTING: Display message Please select a date in the future when select past date C1W4');
    ...
    it('should display message Please select a resort first to quote C1W4', ()=> {

      console.log('TEST STARTING: Display message Please select a resort first to quote C1W4');
    ...
    it('should display message Sorry Last Minute Reservation C1W4', ()=> {

     console.log('TEST STARTING: Display message Sorry Last Minute Reservation C1W4');
    ...
    it('should display message Sorry Last Minute Reservation on step2 Requote C1W4', ()=> {

    console.log('TEST STARTING: Display message Sorry Last Minute Reservation on step 2 Requote C1W4');
    ...
    it('should display message Air cannot be selected for dates more than 330 C1W4', ()=> {

    console.log('TEST STARTING: Display message Air cannotbe selected for dates more than 330 C1W4');
    ...
    console.log('TEST STARTING: Display message Air cannot be selectedfor dates more than 330 Requote C1W4');
