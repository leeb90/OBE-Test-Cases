...
describe('Check the number of Airlines present on the availability result C1W2', function()  {

      this.retries(4);
    
    it('should test Number mentioned in the text and number of flights should be available C1W2', ()=> {

      console.log('TEST STARTING: Number mentioned in the text and number of flights should be available C1W2');
